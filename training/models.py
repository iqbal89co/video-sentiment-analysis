...
class AudioEncoder(nn.Module):
    ...
    def forward(self, x):
        ...
        # Features output: [batch_size, 128]
...
class MultimodalSentimentModel(nn.Module):
    def __init__(self):
        ...
        self.emo_classifier = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Dropout(0.2),
            nn.Linear(64, 7) # anger, disgust, fear, joy, sadness, surprise, neutral
        )
    ...
    def forward(self, text_inputs, video_frames, audio_features):
        ...
        # Concatinate multimodal features
...
class MultimodalTrainer:
    def __init__(self, model, train_loader, val_loader):
        ...
        # Very high: 1, high: 0.1-0.001, medium: 1e-1, low: 1e-4, very low: 1e-5
    ...
    def train_epoch(self):
        ...
        for batch in self.train_loader:
            ...
            emotion_loss = self.emotion_criterion(
                output['emotions'], emotion_labels
            )
            sentiment_loss = self.sentiment_criterion(
                output['sentiments'], sentiment_labels
            )
